...
contract LockedJewelOffer {
    ...
    uint256 public jewelSellAmount;
    ...
    constructor(
        ...
        jewelSellAmount = _jewelSellAmount;
    }
    ...
    function fill() public {
        require(hasEnoughJewel(), "not enough JEWEL balance");
        ...
        emit OfferFilled(msg.sender, jewelSellAmount, tokenWanted, amountWanted);
    }
    ...
    function hasEnoughJewel() public view returns (bool) {
        return JEWEL.totalBalanceOf(address(this)) >= jewelSellAmount;
    }
